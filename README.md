...
<a href="https://www.codecogs.com/eqnedit.php?latex=\large&space;Watt&space;=&space;\cos\phi&space;\cdot&space;V&space;\cdot&space;A" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\large&space;Watt&space;=&space;\cos\phi&space;\cdot&space;V&space;\cdot&space;A" title="\large Watt = \cos\phi \cdot V \cdot A" /></a>

<a href="https://www.codecogs.com/eqnedit.php?latex=\large&space;\cos\phi" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\large&space;\cos\phi" title="\large \cos\phi" /></a> gives the efficiency of the power supply and generally it changes according to the amount of current needed (idle vs under pressure).
